...
export class LinkEnum {
    ...
    public static readonly CREATE_TEAM = new LinkEnum("myTeam", "Squadra", this.PARENT_PATH + "myTeam");
    public static readonly MYTEAM = new LinkEnum("myTeam", "Miei giocatori", this.PARENT_PATH + "myTeam");
    public static readonly PLAYER_LIST = new LinkEnum("playerList", "Giocatori", this.PARENT_PATH + "playerList");
